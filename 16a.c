...
int main(){
    ...
    lock.l_type = F_WRLCK; lock.l_start = 0; lock.l_len = 0; lock.l_whence = SEEK_SET; //SEEK_SET means from start of file and len=0 means lock whole file.
    ...
    getchar();//while the program waits here you can open another instance of this program and see it will be stuck on aquiring lock
